package com.yuxing.trainee.core.redis;

import com.yuxing.trainee.core.lock.redis.RedisClient;
import com.yuxing.trainee.core.lock.redis.RedisDistributedLock;
...
public class RedisDistributedLockTest {
    ...
    public void acquire() {
        ...
        Runnable runnable = () -> {
            ...
            try (Jedis conn = new Jedis("127.0.0.1", 6379)) {
                ...
                lock = new RedisDistributedLock(jedisClient, "test1", 10);
                lockId = lock.acquire();
                if (lockId != null) {
    ...
    @Slf4j
    static class JedisClient implements RedisClient {
